...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="<?= DOCUMENT_ROOT ?>/admin/home" class="brand-link">
    <img src="<?= DOCUMENT_ROOT ?>/public/admin/img/logo.png" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="<?= DOCUMENT_ROOT ?>/public/admin/img/trung-avatar-2.jpg" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
