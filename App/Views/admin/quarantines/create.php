     ...
     <div class="row mb-2">
       ...
       <div class="col-sm-6">
         <ol class="breadcrumb float-sm-right">
           ...
           <li class="breadcrumb-item active">Thêm người cách ly</li>
         </ol>
       </div>
     </div>
   </div>
 ...
 <section class="content">
   ...
   <form action="<?= DOCUMENT_ROOT ?>/admin/quarantine/store" method="post" enctype="multipart/form-data">
     <div class="row">
       <div class="col-md-12">
         <div class="card card-primary">
           <div class="card-header">
             <h3 class="card-title">Nhập thông tin người cách ly</h3>
           </div>
           <div class="card-body">
             ...
             <div class="form-group">
               ...
               <input required type="number" id="identityCard" name="identityCard" class="form-control"></input>
             </div>
             <div class="form-group">
             ...
             <div class="form-group">
               ...
               <input type="text" id="nationality" name="nationality" class="form-control"></input>
             </div>
             <div class="form-group">
               <label for="hometown">Quê quán <span style="color: red;">(*)</span></label>
               <input type="text" id="hometown" name="hometown" class="form-control"></input>
             </div>
             <div class="form-group">
